package com.projectten.webapp.client.application.base.activity;
...
import com.projectten.webapp.client.application.base.place.EntityProxyPlace;
import com.projectten.webapp.client.application.base.place.EntitySearchPlace;
...
public abstract class AbstractProxyEditActivity<P extends EntityProxy> extends AbstractBaseActivity implements Activity, ProxyEditView.Delegate {
    ...
    /**
     * 
     * @see com.projectten.client.application.base.view.ProxyEditView.Delegate#saveClicked()
     */
    @Override
    ...
    /**
     * 
     * @see com.projectten.client.application.base.view.ProxyEditView.Delegate#deleteClicked()
     */
    @Override
    ...
    /**
     * 
     * @see com.projectten.client.application.base.view.ProxyEditView.Delegate#cancelClicked()
     */
    @Override
